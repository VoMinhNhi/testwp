...
add_action('init', 'mn_theme_setup', 10);
...
/**
 * Đăng ký handle cho style.css của theme mẹ và sử dụng như một phần phụ thuộc của style.css theme con
 */

function mn_load_theme_style()
{
